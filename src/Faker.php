...
class Faker
{
    ...
    static public function video($shape): string
    {
        if ($shape == 'fat') {
    ...
    static public function image($shape): string
    {
        if ($shape === 'square') {
    ...
    static public function chinese($min = 3, $max = 0) {
    ...
    static public function date($period = 'future') {
        $now = now();
        if ($period == 'future') {
    ...
    static public function id_card()
    {
        $date = self::date('past');
